namespace BalanceCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void btn_inv_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Заповніть поле а та поле модулю, будь ласка :)");
            }
        }
        //a-b
        ...
        private void btn_prime_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Заповніть поле а, будь ласка :)");
            }
        }
        ...
        private void btn_evk_Click(object sender, EventArgs e)
        {
            if ((string.IsNullOrWhiteSpace(txt_a.Text) || string.IsNullOrWhiteSpace(txt_b.Text)) == false)
            {
                ...
                for (int i = 0; i < B; i++)
                {
                    ...
                    if (Result == 0)
                    {
                        txt_r.Text = string.Format("Найбільший дільник для двох чисел: {0}", minNum);
                        if (minNum == 1)
                            lbl_evk.Text = string.Format("Числа є взаємно прості!");
                        else
                            lbl_evk.Text = string.Format("Числа не є взаємно прості!");
                        break;
                    }
                    else
                    {
            ...
            {
                MessageBox.Show("Заповніть поля a та b , будь ласка :)");
            }
        }
